...
enroot import docker://registry.rcp.epfl.ch#claire/moalla/template-project-name:arm64-cuda-root-latest
...
apptainer pull docker://registry.rcp.epfl.ch/claire/moalla/template-project-name:arm64-cuda-root-latest
```
...
git pull
cd template-project-name/dev/installation/docker-arm64-cuda
```
